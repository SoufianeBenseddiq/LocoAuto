...
const Navbar =()=>{
    ...
    return(
        <>
            ...
            {/**phone screens */}
            <div className={!showNav?' fixed left-0 flex flex-col top-0 py-8 justify-between w-[100%] h-[100%] bg-white items-center text-[#15162f] z-50 ease-in-out duration-[650ms]':'fixed py-8 flex flex-col left-[-100%] w-[100%] ease-in-out duration-[650ms] z-50 pb-24 h-screen top-0 justify-between'}>
